...
class IncomeByServiceView(APIView):
    ...
    def get(self, request):
        ...
        no_service_total = Order.objects.filter(
            user=request.user, status='completed', services__isnull=True,
        ...
        if date_from and date_to:
            try:
                ...
                prev = Order.objects.filter(
                    ...
                    completed_at__date__gte=prev_from, completed_at__date__lte=prev_to,
