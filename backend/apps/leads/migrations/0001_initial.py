    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_value', models.CharField(blank=True, max_length=500, verbose_name='Контакт')),
                ...
                ('contact_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='clients.contacttype', verbose_name='Тип контакта')),
                ('lead_source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='clients.leadsource', verbose_name='Источник')),
